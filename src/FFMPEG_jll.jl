...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import FFMPEG_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("b22a6f82-2f65-5046-a5b2-351ab43fb4e5"))
platforms = [Pkg.Artifacts.unpack_platform(e, "FFMPEG", artifacts_toml) for e in artifacts["FFMPEG"]]
...
if best_platform === nothing
    @debug("Unable to load FFMPEG; unsupported platform $(triplet(platform_key_abi()))")
else
