...
JLLWrappers.@declare_library_product(libavcodec, "libavcodec.so.61")
JLLWrappers.@declare_library_product(libavdevice, "libavdevice.so.61")
JLLWrappers.@declare_library_product(libavfilter, "libavfilter.so.10")
JLLWrappers.@declare_library_product(libavformat, "libavformat.so.61")
JLLWrappers.@declare_library_product(libavutil, "libavutil.so.59")
JLLWrappers.@declare_library_product(libpostproc, "libpostproc.so.58")
JLLWrappers.@declare_library_product(libswresample, "libswresample.so.5")
JLLWrappers.@declare_library_product(libswscale, "libswscale.so.8")
